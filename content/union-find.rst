C union-find я столкнулся проходя вторую часть стэнфордских `алгоритмических курсов <https://www.coursera.org/course/algo2>`_ на `coursera <https://www.coursera.org/>`_.
